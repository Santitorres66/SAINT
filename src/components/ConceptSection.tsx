 ...
 * Mucho aire, tipografía serif, tono sobrio, y cada bloque entrando cuando se
 * llega a él.
 */
    ...
    <section className="mx-auto max-w-4xl px-6 py-28 text-center">
      <Reveal>
        ...
        <p className="mx-auto mt-8 max-w-2xl text-base leading-relaxed text-saint-gray">
          Cada prenda de SAINT nace simple y de calidad. La volvés única a
          través del{" "}
          <span className="text-saint-white">bordado personalizado</span>: tu
          personaje favorito, tu mascota, un símbolo que solo vos entendés. No
          es una estampa más — es artesanía urbana pensada para durar y para
          significar.
        </p>
      </Reveal>
      ...
      <div className="mt-16 grid gap-10 sm:grid-cols-3">
        {[
          ...
          <Reveal key={item.titulo} delay={i * 140}>
